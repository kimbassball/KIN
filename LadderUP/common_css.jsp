...
/* ==================================================
	header
================================================== */
#header{width:100%; position:relative; z-index:99; width:1400px; margin:0; padding:0; height:60px;  border-bottom:2px solid #001433;}
...
#menuWrap .allmenu{background:#484b56 url(/question_pool/img/ico_allmenu.png) no-repeat 20px center; height:58px; line-height:58px;color:#fff; font-size:16px; padding-left:50px; position:relative;}
...
#menuWrap .bookmark p{background:url(/question_pool/img/ico_bookmark.png) no-repeat 0 center; color:#001433; padding:0 20px; font-size:15px; font-weight:600; width:100%; position:relative;}
#menuWrap .bookmark p a{border:1px solid #001433; border-radius:5px; display:inline-block; font-size:14px; font-weight:400; padding:0 8px; margin-left:3px;}
#menuWrap .bookmark p span{position:absolute; right:0;}
#menuWrap .bookmark ul{margin-top:10px;}
#menuWrap .bookmark li{background:url(/question_pool/img/menu_2dep_off.png) no-repeat 20px center; padding:4px; padding-left:35px; font-size:14px; cursor:pointer;}
#menuWrap .gnb{}
#menuWrap .gnb dt{background:url(/question_pool/img/menu_off.png) no-repeat 20px center; padding:15px 20px; padding-left:45px; color:#161f2c; font-size:15px; font-weight:400; border-top:1px solid #ffffff; border-bottom:1px solid #dddddd;}
#menuWrap .gnb dt.on{background:#001433 url(/question_pool/img/menu_on.png) no-repeat 20px center; color:#fff;}
#menuWrap .gnb dd{background:#e6e6e6; padding:10px 20px; display:none;}
#menuWrap .gnb dd li{background:url(/question_pool/img/menu_2dep_off.png) no-repeat 25px center; padding:4px; padding-left:40px; font-size:15px;}
#menuWrap .gnb dd li.on{background:url(/question_pool/img/menu_2dep_on.png) no-repeat 25px center; color:#001433; font-size: 16px; font-weight: 400;}
...
.tabWrap .tab li.on{background:#001433; border:1px solid #001433; border-bottom:none; color:#fff; }
...
.main .box h2{color:#001433 !important; font-size:18px; font-weight:600;}

.scheduleSearch > div{padding-top:10px; clear:both;}
.scheduleSearch .date input[type=text]{width:160px;}
.scheduleSearch .date input[type=button]{width:32px; height:32px; background:#bfbfbf url('/question_pool/img/btn_calender.png') no-repeat center center;}
.scheduleSearch .search{width:100px; border:none; height:32px; background:#515151 url('/question_pool/img/btn_search.png') no-repeat 18px center; padding:0; padding-left:38px; width:85px; color:#fff !important; font-size:14px; }
...
.linkSearch .search{width:100px; border:none; height:32px; background:#515151 url('/question_pool/img/btn_search.png') no-repeat 18px center; padding:0; padding-left:38px; width:85px; color:#fff !important; font-size:14px; }
...
.linkBox li.link01{background:#f5f5f5 url(/question_pool/img/main_link01.png) no-repeat 20px center; padding-left:50px; border:1px solid #dddddd;}
.linkBox li.link02{background:#f5f5f5 url(/question_pool/img/main_link02.png) no-repeat 20px center; padding-left:50px; border:1px solid #dddddd;}
.linkBox li.link03{background:#f5f5f5 url(/question_pool/img/main_link03.png) no-repeat 20px center; padding-left:50px; border:1px solid #dddddd;}
...
.blTab{position:relative; overflow:hidden; border-bottom:1px solid #001433; margin-top:10px; cursor:pointer;}
.blTab li{float:left; width:80px; background:#e6e6e6; padding:5px 20px; color:#161f2c; text-align:center; margin-right:1px;}
.blTab li.on{background:#001433; color:#fff; font-weight:400;}
.main .bl table{}
...
.txt_red{color:#001433 !important;}
...
.selectric-dSelect .button{right:10px;top:12px;width:12px;height:7px;background:url("/question_pool/img/list_arrow.png") no-repeat left top}
