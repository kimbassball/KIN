...
.pageTitle .prevPage{background:#484b56 url('/question_pool/img/btn_prevPage.png') no-repeat 20px center; color:#fff; border-radius:5px; padding:6px 15px 6px 40px;}
...
.pagenate li a.board.first {background: url('/question_pool/img/ico_first.png') no-repeat center center;}
.pagenate li a.board.prev {margin-right:10px; background: url('/question_pool/img/ico_prev.png') no-repeat center center;}
.pagenate li a.board.next {margin-left:10px; background: url('/question_pool/img/ico_next.png') no-repeat center center;}
.pagenate li a.board.last {background: url('/question_pool/img/ico_last.png') no-repeat center center;}
...
.plus{width:30px; height:30px; background:#bfbfbf url('/question_pool/img/btn_plus.png') no-repeat center center; border:none; border-radius:6px;}
.del{width:30px; height:30px; background:#bfbfbf url('/question_pool/img/btn_del.png') no-repeat center center; border:none; border-radius:6px;}
...
.searchWrap .date input[type=button]{width:32px; height:32px; background:#bfbfbf url('/question_pool/img/btn_calender.png') no-repeat center center;}
.searchWrap .search{width:100px; height:32px; background:#808080 url('/question_pool/img/btn_search.png') no-repeat 20px center; padding-left:30px;}
.searchWrap .searchSmall{width:30px; height:32px; background:#515151 url('/question_pool/img/btn_search.png') no-repeat 20px center; padding-left:30px;}
...
.bbs .list table{border-top:1px solid #001433;}
...
.bbs .list thead th.blank{background:#fff !important; border-top:1px solid #fff !important; border-bottom:1px solid #001433 !important; border-right:1px solid #001433 !important;}
...
.bbs .list  h3{background:url(/question_pool/img/list_h3.png) no-repeat left center; padding-left:24px; color:#484b56; font-size:16px; margin-bottom:10px;}
...
.deadline{color:#001433 !important;}
...
.bbs .write table{border-top:1px solid #001433;}
...
.bbs .write .divT{padding:10px; clear:both; position:relative; border-top:1px solid #001433;  border-bottom:1px solid #dddddd; min-height:55px;}
...
.bbs .write .date input[type=button]{width:32px; height:32px; background:#bfbfbf url('/question_pool/img/btn_calender.png') no-repeat center center;}
...
/* 화물진행상태 */
.tracking{padding:10px 0; clear:both; position:relative; border-top:1px solid #001433; overflow:hidden; }
...
.tracking p:after{content:""; position:absolute; left:50%; background:url(/question_pool/img/line_arrow.png) no-repeat; width:21px; height:10px; top:100%;}
.tracking dl{width:9.777%; margin-right:1.5%; float:left; margin-top:20px; position:relative; }
.tracking dl:after{content:""; position:absolute; left:102%; background:url(/question_pool/img/tracking_arrow.png) no-repeat; width:9px; height:15px; top:25%;}
...
.infomation .redPt{color:#a50800; background:url('/question_pool/img/ico_redPt.png') no-repeat left 4px; margin:10px 0; padding-left:30px; font-weight:400;}
...
.infomationBg li{background:url('/question_pool/img/ico_redStar.png') no-repeat 5px 5px; padding-left:20px; color:#161f2c; font-weight:400;}

.freetimeTab{position:relative; overflow:hidden; border-bottom:1px solid #001433; margin-top:10px; cursor:pointer;}
.freetimeTab li{float:left; width:120px; background:#e6e6e6; padding:5px 20px; color:#161f2c; text-align:center; margin-right:1px;}
.freetimeTab li.on{background:#001433; color:#fff; font-weight:400;}
...
.dateBtn{display:block; width:28px; height:28px; border-radius:5px; background:#bfbfbf url('/question_pool/img/btn_calender.png') no-repeat center center; text-indent:-9999px; margin:auto;}